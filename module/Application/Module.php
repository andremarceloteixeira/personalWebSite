...
class Module
{
    public function onBootstrap(MvcEvent $e)
    {
     ...
     public function bootstrapSession($e) 
     {
        ...
        $country = $request->getQuery()->get('country');
        if (!is_null($country)) {
            if (in_array($country, $configModel->getCountryLangs())) {
                $container->offsetSet('country', $country);
            }
        }
    ...
    public function getServiceConfig()
    {
        return array(
            'factories' => array(
                'CoreModel' => 'Application\Service\CoreFactory',
